...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ScreenedImage.orphaned'
        db.add_column('plantshare_screenedimage', 'orphaned',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ScreenedImage.orphaned'
        db.delete_column('plantshare_screenedimage', 'orphaned')
