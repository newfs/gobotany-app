...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sighting.visibility'
        db.add_column(u'plantshare_sighting', 'visibility',
                      self.gf('django.db.models.fields.CharField')(default='PUBLIC', max_length=7),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Sighting.visibility'
        db.delete_column(u'plantshare_sighting', 'visibility')
