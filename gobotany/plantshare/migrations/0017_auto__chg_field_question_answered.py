...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Question.answered'
        db.alter_column('plantshare_question', 'answered', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'Question.answered'
        db.alter_column('plantshare_question', 'answered', self.gf('django.db.models.fields.DateTimeField')(default=None))
    ...
    models = {
        ...
        'plantshare.question': {
            ...
            'answered_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'questions_answered'", 'blank': 'True', 'to': "orm['auth.User']"}),
