...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ScreenedImage.screened'
        db.alter_column('plantshare_screenedimage', 'screened', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'ScreenedImage.screened'
        db.alter_column('plantshare_screenedimage', 'screened', self.gf('django.db.models.fields.DateTimeField')(default=None))
