...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'UserProfile', fields ['display_name']
        db.delete_unique(u'plantshare_userprofile', ['display_name'])


    def backwards(self, orm):
        # Adding unique constraint on 'UserProfile', fields ['display_name']
        db.create_unique(u'plantshare_userprofile', ['display_name'])
