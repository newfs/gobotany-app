...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ScreenedImage.deleted'
        db.add_column('plantshare_screenedimage', 'deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ScreenedImage.deleted'
        db.delete_column('plantshare_screenedimage', 'deleted')
