...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ScreenedImage'
        db.create_table('plantshare_screenedimage', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('image', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
            ('uploaded', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('uploaded_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='images_uploaded', to=orm['auth.User'])),
            ('image_type', self.gf('django.db.models.fields.CharField')(max_length=10, blank=True)),
            ('screened', self.gf('django.db.models.fields.DateTimeField')(blank=True)),
            ('screened_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='images_approved', null=True, to=orm['auth.User'])),
            ('is_approved', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('plantshare', ['ScreenedImage'])


    def backwards(self, orm):
        # Deleting model 'ScreenedImage'
        db.delete_table('plantshare_screenedimage')
    ...
    models = {
        ...
        'plantshare.screenedimage': {
            ...
            'screened': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'}),
