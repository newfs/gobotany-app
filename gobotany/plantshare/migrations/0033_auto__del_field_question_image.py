...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'plantshare_question', 'image_id')

        # Adding M2M table for field images on 'Question'
        db.create_table(u'plantshare_question_images', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('question', models.ForeignKey(orm[u'plantshare.question'], null=False)),
            ('screenedimage', models.ForeignKey(orm[u'plantshare.screenedimage'], null=False))
        ))
        db.create_unique(u'plantshare_question_images', ['question_id', 'screenedimage_id'])


    def backwards(self, orm):
        # Adding field 'Question.image'
        db.add_column(u'plantshare_question', 'image',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['plantshare.ScreenedImage'], null=True, blank=True),
                      keep_default=False)

        # Removing M2M table for field images on 'Question'
        db.delete_table('plantshare_question_images')
