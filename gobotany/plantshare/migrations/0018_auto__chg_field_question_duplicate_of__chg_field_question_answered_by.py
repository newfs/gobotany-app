...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Question.duplicate_of'
        db.alter_column('plantshare_question', 'duplicate_of_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['plantshare.Question']))

        # Changing field 'Question.answered_by'
        db.alter_column('plantshare_question', 'answered_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

    def backwards(self, orm):

        # Changing field 'Question.duplicate_of'
        db.alter_column('plantshare_question', 'duplicate_of_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['plantshare.Question']))

        # Changing field 'Question.answered_by'
        db.alter_column('plantshare_question', 'answered_by_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.User']))
