...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserProfile.sharing_visibility'
        db.delete_column(u'plantshare_userprofile', 'sharing_visibility')

        # Adding field 'UserProfile.details_visibility'
        db.add_column(u'plantshare_userprofile', 'details_visibility',
                      self.gf('django.db.models.fields.CharField')(default='USERS', max_length=7),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'UserProfile.sharing_visibility'
        db.add_column(u'plantshare_userprofile', 'sharing_visibility',
                      self.gf('django.db.models.fields.CharField')(default='PRIVATE', max_length=7),
                      keep_default=False)

        # Deleting field 'UserProfile.details_visibility'
        db.delete_column(u'plantshare_userprofile', 'details_visibility')
