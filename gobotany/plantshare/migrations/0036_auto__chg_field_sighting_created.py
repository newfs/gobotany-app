...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Sighting.created'
        db.alter_column(u'plantshare_sighting', 'created', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'Sighting.created'
        db.alter_column(u'plantshare_sighting', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
