...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.location_visibility'
        db.add_column('plantshare_userprofile', 'location_visibility',
                      self.gf('django.db.models.fields.CharField')(default='PRIVATE', max_length=7),
                      keep_default=False)

        # Adding field 'UserProfile.location'
        db.add_column('plantshare_userprofile', 'location',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['plantshare.Location'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.location_visibility'
        db.delete_column('plantshare_userprofile', 'location_visibility')

        # Deleting field 'UserProfile.location'
        db.delete_column('plantshare_userprofile', 'location_id')
