...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ScreenedImage.image'
        db.alter_column('plantshare_screenedimage', 'image', self.gf('imagekit.models.fields.ProcessedImageField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'ScreenedImage.image'
        db.alter_column('plantshare_screenedimage', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100))
