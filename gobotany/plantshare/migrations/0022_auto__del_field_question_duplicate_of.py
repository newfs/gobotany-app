...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Question.duplicate_of'
        db.delete_column('plantshare_question', 'duplicate_of_id')


    def backwards(self, orm):
        # Adding field 'Question.duplicate_of'
        db.add_column('plantshare_question', 'duplicate_of',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='duplicates', null=True, to=orm['plantshare.Question'], blank=True),
                      keep_default=False)
