...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('plantshare_userprofile', 'sharing_visibility',
                      self.gf('django.db.models.fields.CharField')(default='PRIVATE', max_length=7),
                      keep_default=False)

        # Adding field 'UserProfile.saying'
        db.add_column('plantshare_userprofile', 'saying',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('plantshare_userprofile', 'sharing_visibility')

        # Deleting field 'UserProfile.saying'
        db.delete_column('plantshare_userprofile', 'saying')
    ...
    models = {
        ...
        'plantshare.sighting': {
            ...
            'state': ('django.db.models.fields.CharField', [], {'max_length': '60', 'blank': 'True'}),
