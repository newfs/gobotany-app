...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('plantshare_question', 'answered')

        # Deleting field 'Question.answered_by'
        db.delete_column('plantshare_question', 'answered_by_id')


    def backwards(self, orm):
        # Adding field 'Question.answered'
        db.add_column('plantshare_question', 'answered',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Question.answered_by'
        db.add_column('plantshare_question', 'answered_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='questions_answered', null=True, to=orm['auth.User'], blank=True),
                      keep_default=False)
