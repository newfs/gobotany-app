...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'plantshare_question', 'category')


    def backwards(self, orm):
        # Adding field 'Question.category'
        db.add_column(u'plantshare_question', 'category',
                      self.gf('django.db.models.fields.CharField')(default='General', max_length=120),
                      keep_default=False)
