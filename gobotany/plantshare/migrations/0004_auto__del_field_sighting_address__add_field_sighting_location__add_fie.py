...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Sighting.address'
        db.delete_column('plantshare_sighting', 'address')
    ...
    def backwards(self, orm):
        # Adding field 'Sighting.address'
        db.add_column('plantshare_sighting', 'address',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Deleting field 'Sighting.location'
        db.delete_column('plantshare_sighting', 'location')
