...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ScreenedImage.latitude'
        db.add_column(u'plantshare_screenedimage', 'latitude',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ScreenedImage.longitude'
        db.add_column(u'plantshare_screenedimage', 'longitude',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ScreenedImage.latitude'
        db.delete_column(u'plantshare_screenedimage', 'latitude')

        # Deleting field 'ScreenedImage.longitude'
        db.delete_column(u'plantshare_screenedimage', 'longitude')
